...
# 04 pulse check
      ...
      def CALI_report_1(self):
          ...
          a_func.GetGain(self.fembs, datadir, self.savedir, "CALI1/", "CALI1_SE_{}_{}_{}_0x{:02x}", "200mVBL", "4_7mVfC", "2_0us", dac_list, 10000)
          a_func.GetENC(self.fembs, "200mVBL", "4_7mVfC", "2_0us", 0, self.savedir, "CALI1/")

          datadir = self.datadir+"CALI1/"
          print("analyze CALI1 200mVBL 7_8mVfC 2_0us")
          a_func.GetGain(self.fembs, datadir, self.savedir, "CALI1/", "CALI1_SE_{}_{}_{}_0x{:02x}", "200mVBL", "7_8mVfC", "2_0us", dac_list)
          a_func.GetENC(self.fembs, "200mVBL", "7_8mVfC", "2_0us", 0, self.savedir, "CALI1/")
          #
          datadir = self.datadir+"CALI1/"
          print("analyze CALI1 200mVBL 14_0mVfC 2_0us")
          a_func.GetGain(self.fembs, datadir, self.savedir, "CALI1/", "CALI1_SE_{}_{}_{}_0x{:02x}", "200mVBL", "14_0mVfC", "2_0us", dac_list)
          a_func.GetENC(self.fembs, "200mVBL", "14_0mVfC", "2_0us", 0, self.savedir, "CALI1/")
          #
          datadir = self.datadir+"CALI1/"
          print("analyze CALI1 200mVBL 25_0mVfC 2_0us")
          a_func.GetGain(self.fembs, datadir, self.savedir, "CALI1/", "CALI1_SE_{}_{}_{}_0x{:02x}", "200mVBL", "25_0mVfC", "2_0us", dac_list)
          a_func.GetENC(self.fembs, "200mVBL", "25_0mVfC", "2_0us", 0, self.savedir, "CALI1/")

          datadir = self.datadir+"CALI1/"
          print("analyze CALI1 200mVBL 14_0mVfC 2_0us")
          a_func.GetGain(self.fembs, datadir, self.savedir, "CALI1_DIFF/", "CALI1_DIFF_{}_{}_{}_0x{:02x}", "200mVBL", "14_0mVfC", "2_0us", dac_list)
