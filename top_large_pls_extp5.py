...
if True:
    ...
    #LArASIC register configuration
        #chk.set_fe_board(sts=1, snc=0,sg0=0, sg1=0, st0=0, st1=0, swdac=1, sdd=sdd,dac=0x18 )
        ...
        chk.set_fechip(chip=1, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0, swdac=2, sdd=sdd, sgp=0, dac=0x00)
        chk.set_fechip(chip=2, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0, swdac=2, sdd=sdd, sgp=0, dac=0x00)
        chk.set_fechip(chip=3, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0, swdac=2, sdd=sdd, sgp=0, dac=0x00)
        chk.set_fechip(chip=5, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0, swdac=2, sdd=sdd, sgp=0, dac=0x00)
        chk.set_fechip(chip=6, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0, swdac=2, sdd=sdd, sgp=0, dac=0x00)
        chk.set_fechip(chip=7, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0, swdac=2, sdd=sdd, sgp=0, dac=0x00)
        ...
        #chk.set_fechip(chip=0, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0, swdac=1, sdd=sdd,sgp=0, dac=0x3f)

        #chk.set_fechn_reg(chip=0, chn=0, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0)
        #chk.set_fechn_reg(chip=0, chn=1, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0)
        #chk.set_fechn_reg(chip=0, chn=2, sts=1, snc=1,sg0=0, sg1=0, st0=0, st1=0)
        ...
        #chk.set_fechip_global(chip=0, slk0=0, slk1=0, swdac=2, sdd=sdd, sgp=0, dac=0x00)
