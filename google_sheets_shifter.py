...
def google_sheets_shifter():
    ...
    try: 
        ...
        shifters[1] = ";sgao@bnl.gov;"
        shifters[2] = ";sgao@bnl.gov;"
        shifters[3] = ";sgao@bnl.gov;"
        shifters[4] = ";sgao@bnl.gov;"
        shifters[5] = ";sgao@bnl.gov;"
        shifters[6] = ";sgao@bnl.gov;"
        shifters[7] = ";sgao@bnl.gov;"
    return shifters
