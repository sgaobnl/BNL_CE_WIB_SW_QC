...
RT_CRITERIA = {
    ...
    "col_b": "ASICDAC_47mV_CHK_x10",
    "vdda_range": (35, 40),
    "vddo_range": (0.01, 0.1),
    "vddp_range": (55, 75),
    "ped_range": (600, 1200),
    "rms_range": (2, 10),
    "posamp_range": (3200, 3400),
}
...
LN_CRITERIA = {
    ...
    "ped_range": (600, 1200),
    "rms_range": (2, 10),
    "posamp_range": (3000, 3200),
}


def check_row21(rows, file_type):
    """Check 4 - Row 21. RT and LN criteria are kept separately."""
    if file_type == "RT":
    ...
    return _check_row(rows, 21, criteria)
