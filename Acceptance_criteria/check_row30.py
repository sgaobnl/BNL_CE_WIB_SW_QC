...
def check_row30(rows, file_type):
    """
    Check Row 30.

    RT and LN use separate numeric criteria dictionaries. Column A and Column B are taken from the actual row.
