...
RT_CRITERIA = {
    ...
    "col_b": "ASICDAC_47mV_CHK_x18",
    "vdda_range": (35, 40),
    "vddo_range": (0.01, 0.1),
    "vddp_range": (55, 75),
    "ped_range": (600, 1200),
    "rms_range": (2, 10),
    "posamp_range": (4800, 5200),
}
...
LN_CRITERIA = {
    ...
    "ped_range": (600, 1200),
    "rms_range": (2, 10),
    "posamp_range": (4450, 4850),
}


def check_row22(rows, file_type):
    """Check 4 - Row 22. RT and LN criteria are kept separately."""
    if file_type == "RT":
    ...
    return _check_row(rows, 22, criteria)
