...
if True:
    ...
    #LArASIC register configuration
        chk.set_fe_board(sts=0, snc=sample_N%2,sg0=0, sg1=0, st0=0, st1=0, swdac=1, sdd=sdd,dac=0x20 )
...
####################FEMBs Data taking################################
rawdata = chk.spybuf_trig(fembs=fembs, num_samples=sample_N, trig_cmd=0xff, spy_rec_ticks=0x7f00, fastchk=True) #returns list of size 1
