...
env = input ("RT or LN2: ")
cts_sts = input ("CTS power (ON or OFF): ")
...
for st in range(4):
    ...
    #LArASIC register configuration
        chk.set_fe_board(sts=0, snc=0, sg0=0, sg1=0, st0=st0, st1=st1, swdac=0, sdd=sdd,dac=0x00 )
    ...
    if save:
        ...
        fp = fdir + env + "_CTS_" + cts_sts + "_Raw_" + ts  + "_st1%s_st0%s"%(st1,st0) + ".bin"
        print (fp)
