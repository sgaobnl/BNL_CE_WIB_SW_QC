...
print("\033[35m" + "A_RT04_slot_02 : WIB_FEMB_Pulse" + "\033[0m")
...
target_file_path = os.path.join(base_dir, "..", "report", "WIB_to_FEMB_slot_02_power_report")
...
for fembi in [2]:
    ...
    try:
        import sys
        sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))
        from function.csv_export import export_test0402_to_csv
        csv_path = export_test0402_to_csv(result_dict)
