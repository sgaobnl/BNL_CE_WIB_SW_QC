...
if rp_dict.csv_manager:
    ...
    rp_dict.csv_manager.batch_update([
        {"item_id": "T03_4V_00", "value": round(v1_wib, 3), "status": v1_status},
        {"item_id": "T03_4V_01", "value": round(c1_wib, 3), "status": c1_status},
        {"item_id": "T03_4V_02", "value": round(v2_wib, 3), "status": v2_status},
        {"item_id": "T03_4V_03", "value": round(c2_wib, 3), "status": c2_status}
    ])
...
if rp_dict.csv_manager:
    ...
    for slot, slot_dict in slot_dicts:
        ...
        for rail, rail_name in zip(rails, rail_names):
            ...
            updates.append({
                "item_id": f"T03_4V_{slot}{rail_name}_V",
                "value": round(v_meas, 3),
                "status": v_status
            })
            updates.append({
                "item_id": f"T03_4V_{slot}{rail_name}_I",
...
if rp_dict.csv_manager:
    rp_dict.csv_manager.update_item("T03_4V_99", test_duration, status="COMPLETE")
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="subtitle">FEMB Power Rail Test Report (Test03 - 4V)</div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value">4 FEMB Slots, 5 Power Rails each (4V test voltage)</div>
            </div>
        </div>
    ...
    html_content += f"""
        <div class="section">
            ...
            <div class="test-description">
                <strong>Test Configuration:</strong> Set voltage = 4V for FE/CD/ADC/IDLE, 5V for BIAS
            </div>
            <table>
                <thead>
                    <tr>
