...
print("\n" + "="*60)
print("\033[35m" + "A_RT03_02 : FEMB Power Rail Test (2V)" + "\033[0m")
print("="*60)
...
if rp_dict.csv_manager:
    ...
    rp_dict.csv_manager.batch_update([
        {"item_id": "T03_2V_00", "value": round(v1_wib, 3), "status": v1_status},
        {"item_id": "T03_2V_01", "value": round(c1_wib, 3), "status": c1_status},
        {"item_id": "T03_2V_02", "value": round(v2_wib, 3), "status": v2_status},
        {"item_id": "T03_2V_03", "value": round(c2_wib, 3), "status": c2_status}
    ])
...
if rp_dict.csv_manager:
    ...
    for slot, slot_dict in slot_dicts:
        ...
        for rail, rail_name in zip(rails, rail_names):
            ...
            updates.append({
                "item_id": f"T03_2V_{slot}{rail_name}_V",
                "value": round(v_meas, 3),
                "status": v_status
            })
            updates.append({
                "item_id": f"T03_2V_{slot}{rail_name}_I",
...
if rp_dict.csv_manager:
    rp_dict.csv_manager.update_item("T03_2V_99", test_duration, status="COMPLETE")

import os

# === Setup relative path to ../report/WIB_03_2V_power_report.html ===
base_dir = os.path.dirname(os.path.abspath(__file__))
target_file_path = os.path.join(base_dir, "..", "report", "WIB_03_2V_power_report.html")
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="subtitle">FEMB Power Rail Test Report (Test03 - 2V)</div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value">4 FEMB Slots, 5 Power Rails each (2V test voltage)</div>
            </div>
        </div>
    ...
    html_content += f"""
        <div class="section">
            ...
            <div class="test-description">
                <strong>Test Configuration:</strong> Set voltage = 2V for FE/CD/ADC/IDLE, 5V for BIAS
            </div>
            <table>
                <thead>
                    <tr>
...
psu.safe_power_off()
psu.close()
print("\033[32mTest03 (2V) completed successfully!\033[0m")
