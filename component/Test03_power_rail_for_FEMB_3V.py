...
print("\n" + "="*60)
print("\033[35m" + "A_RT03_02 : FEMB Power Rail Test (3V)" + "\033[0m")
print("="*60)
...
if rp_dict.csv_manager:
    ...
    for slot, slot_dict in slot_dicts:
        ...
        for rail, rail_name in zip(rails, rail_names):
            ...
            updates.append({
                "item_id": f"T03_3V_{slot}{rail_name}_V",
...
if rp_dict.csv_manager:
    rp_dict.csv_manager.update_item("T03_3V_99", test_duration, status="COMPLETE")

import os

# === Setup relative path to ../report/WIB_03_3V_power_report.html ===
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="subtitle">FEMB Power Rail Test Report (Test03 - 3V)</div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value">4 FEMB Slots, 5 Power Rails each (3V test voltage)</div>
            </div>
        </div>
    ...
    html_content += f"""
        <div class="section">
            ...
            <div class="test-description">
                <strong>Test Configuration:</strong> Set voltage = 3V for FE/CD/ADC/IDLE, 5V for BIAS
            </div>
            <table>
                <thead>
                    <tr>
...
psu.safe_power_off()
psu.close()
print("\033[32mTest03 (3V) completed successfully!\033[0m")
