...
##  === 01 power start =====================
print("\033[35m" + "A_RT04 : WIB_to_FEMB" + "\033[0m")
print("Power on")
ps = Power.RIGOL_PS_CTL()
ps.ps_init()
CH = 1
if ps.get_on_off(channel=CH):
    print("CH1 is ON")
ps.off(channels=[1])
time.sleep(1)
ps.on(channels=[1])
...
# tcp_ip = os.system('ping 192.168.121.2')
tcp_ip = ping_host(ip_address="192.168.121.1", count=4)
if tcp_ip:
    print('TCP/IP Pass!')
else:
    print('TCP/IP Failed! Check connection with P16')
# WIB_IP = input("link with 192.168.121.1 (y/n)")
# time.sleep(3)
# if (WIB_IP == 'y'):
#     print("The WIB_IP is linked now")
# else:
#     print("Please link with WIB_IP")
#     putty = int(input("link with 192.168.121.1 (y/n)"))
udp = ping_host(ip_address="192.168.121.2", count=4)
if udp:
    print('UDP Pass!')
else:
    print('UDP Failed! Check connection with P15')

time.sleep(1)
import temp as initial  # like putty, enable the wib thread
time.sleep(1)

# putty = input("link with putty (y/n)")
# if (putty == 'y'):
#     print("The putty is open now")
# else:
#     print("Please link with putty")
#     putty = int(input("link with putty (y/n)"))
## =========================================

## ==========BREAK_FOR_DEBUG================
# print("Break01")
# Break = input("Pass01 (y/n)")
## =========================================
