...
def DecodeRawData_func(root_path, data_dir, env, tms):
    ...
    if tms == 8:
        ...
        #data_dir = 'Time_20250911145155_DUT_0000_1001_2002_3003_4004_5005_6006_7007'
        cap = QC_Cap_Meas(root_path=root_path, data_dir=data_dir, output_path=output_path, env=env)
        FE_IDs = cap.decode_CapMeas()
        #FE_IDs = ['006_02309_20251003123156_Tray03_SKT3']
        #FE_IDs = ['002_00980_20250915181349_Tray58_SKT2']
...
##        if False:
#            if ("B002" in onedir) and ("T0001" in  onedir):
#                Bdirs.append(onedir)
#            if ("B002" in onedir) and ("T0002" in  onedir):
#                Bdirs.append(onedir)
#            if ("B002" in onedir) and ("T0003" in  onedir):
#                Bdirs.append(onedir)
#            if ("B002" in onedir) and ("T0004" in  onedir):
#                Bdirs.append(onedir)
#            if ("B002" in onedir) and ("T0005" in  onedir):
#                Bdirs.append(onedir)
#
#        if False:
#            if ("B002" in onedir) and ("T0006" in  onedir):
#                Bdirs.append(onedir)
#            if ("B002" in onedir) and ("T0007" in  onedir):
#                Bdirs.append(onedir)
#            if ("B002" in onedir) and ("T0008" in  onedir):
#                Bdirs.append(onedir)
#            if ("B002" in onedir) and ("T0009" in  onedir):
#                Bdirs.append(onedir)
#            if ("B002" in onedir) and ("T0010" in  onedir):
#                Bdirs.append(onedir)
#            if ("B002" in onedir) and ("T0011" in  onedir):
#                Bdirs.append(onedir)
#
#        if False:
#            if ("B006" in onedir) and ("T0001" in  onedir):
#                Bdirs.append(onedir)
#            if ("B006" in onedir) and ("T0002" in  onedir):
#                Bdirs.append(onedir)
#            if ("B006" in onedir) and ("T0003" in  onedir):
#                Bdirs.append(onedir)
#            if ("B006" in onedir) and ("T0004" in  onedir):
#                Bdirs.append(onedir)
#            if ("B006" in onedir) and ("T0005" in  onedir):
#                Bdirs.append(onedir)
#
#        if False:
#            if ("B009" in onedir) and ("T0001" in  onedir):
#                Bdirs.append(onedir)
#            if ("B009" in onedir) and ("T0002" in  onedir):
#                Bdirs.append(onedir)
#            if ("B009" in onedir) and ("T0003" in  onedir):
#                Bdirs.append(onedir)
#            if ("B009" in onedir) and ("T0004" in  onedir):
#                Bdirs.append(onedir)
#            if ("B009" in onedir) and ("T0005" in  onedir):
#                Bdirs.append(onedir)
#
#        if True:
#            if ("B009" in onedir) and ("T0006" in  onedir):
#                Bdirs.append(onedir)
#            if ("B009" in onedir) and ("T0007" in  onedir):
#                Bdirs.append(onedir)
#            if ("B009" in onedir) and ("T0008" in  onedir):
#                Bdirs.append(onedir)
#            if ("B009" in onedir) and ("T0009" in  onedir):
#                Bdirs.append(onedir)
#            if ("B009" in onedir) and ("T0010" in  onedir):
#                Bdirs.append(onedir)
#        if False:
#            if ("B010" in onedir) and ("T0001" in  onedir):
#                Bdirs.append(onedir)
#            if ("B010" in onedir) and ("T0002" in  onedir):
#                Bdirs.append(onedir)
#            if ("B010" in onedir) and ("T0003" in  onedir):
#                Bdirs.append(onedir)
#            if ("B010" in onedir) and ("T0004" in  onedir):
#                Bdirs.append(onedir)
#            if ("B010" in onedir) and ("T0005" in  onedir):
#                Bdirs.append(onedir)
#
#        if False:
#            if ("B010" in onedir) and ("T0006" in  onedir):
#                Bdirs.append(onedir)
#            if ("B010" in onedir) and ("T0007" in  onedir):
#                Bdirs.append(onedir)
#            if ("B010" in onedir) and ("T0008" in  onedir):
#                Bdirs.append(onedir)
#            if ("B010" in onedir) and ("T0009" in  onedir):
#                Bdirs.append(onedir)
#            if ("B010" in onedir) and ("T0010" in  onedir):
#                Bdirs.append(onedir)
#
#        if False:
#            if ("B011" in onedir) and ("T0001" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0002" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0003" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0004" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0005" in  onedir):
#                Bdirs.append(onedir)
#
#        if False:
#            if ("B011" in onedir) and ("T0006" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0007" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0008" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0009" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0010" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0011" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0012" in  onedir):
#                Bdirs.append(onedir)
#            if ("B011" in onedir) and ("T0013" in  onedir):
#                Bdirs.append(onedir)
